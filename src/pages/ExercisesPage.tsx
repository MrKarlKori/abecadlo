export function ExercisesPage() {
  return (
    <div className="max-w-2xl mx-auto flex flex-col items-center justify-center min-h-[60vh] text-center p-8">
      <div className="vintage-card p-12 w-full transform -rotate-2">
        ...
        <p className="font-serif italic text-lg opacity-80">
          This facility is currently being upgraded. Please report back during Phase 2 for new linguistic exercises.
        </p>
        <div className="mt-8 border-t-2 border-dashed border-vintage-ink pt-4">
          <div className="vintage-stamp text-sm relative rotate-0 inline-block">
